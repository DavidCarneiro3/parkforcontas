...
<br />
    <?php
        $id = ($_GET['idtipodoc'])?$_GET['idtipodoc']:$_POST['idtipodoc'];
        if($_POST['btn']){
            $params = [
            ...
            if($result->result === "sucess"){
                echo '<script>alert("Tipo de Documento Atualizado.")</script>';
        ...
        if($_POST['del']){
            ...
            if($del->result == 'sucess'){
                ...
                window.location.href = "busca_tip_doc.php";
                </script>';
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Inserir Tipo de Documento</h2>
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tipo" id="tipo" size="3" class="form-control" value="<?=$list[0]->tipo?>"  placeholder="Tipo. Contratos. Alvará, Certificado..">
                        </div>
                        <div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="ATIVO" name="status" id="ativo" <?=($list[0]->status == 'ATIVO')?'checked':''?>>
                                <label class="form-check-label" for="ativo"> Ativo</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" value="DESATIVADO" type="radio" name="status" id="desativado" <?=($list[0]->status == 'DESATIVADO')?'checked':''?>>
                        ...
                        <div class="form-group">
                            <input type="hidden" name="idtipodoc" value="<?=$_GET['idtipodoc']?>"/>
                            <a class="btn btn-info" href="javascript:location.href = 'busca_tip_doc.php'">Voltar</a>
