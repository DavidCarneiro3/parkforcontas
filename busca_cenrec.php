...
<br />
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Centro de Custo Contas a Receber</h2>
    ...
    <?php 
     ...
     if($_POST['btn']){
        ...
        $params = [
         ...
         $result = json_decode(listaCentrosRec($params));
         //print_r($result);
		...
		<div class="row">
            ...
            <table class="table cell-border" id="mytable">
                ...
                <?php foreach($list as $item){ ?>
                    <tr>
                        <td><?=$item->idcentrorec?></td>
                        <td><?=$item->centro?></td>
                        <!-- <td><?=$item->empresa?></td> -->
                        <td><?=$item->obs?></td>
                        <td>
                            <a href="edt_centrec.php?idcentro=<?=$item->idcentrorec?>" title="Editar Centro" target="blank"><i class="fa fa-gear" aria-hidden="true"></i></s>
