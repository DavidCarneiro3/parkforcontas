...
<br />
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Inserir Documento</h2>
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post" enctype="multipart/form-data" data-ajax="false">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                ...
                                ?>
                                  <option value="<?=$key->idtipodoc?>"><?=$key->tipo?></option>
                                <?php 
                                }
                                ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                foreach($cli as $key){
                                ?>
                                  <option value="<?=$key->idcli?>"><?=$key->cliente.' - '.$key->nome_fantasia?></option>
                                <?php 
                                }
                                ?>
                            </select>
                        ...
                        <label style="float: left; margin-left: 2%;">Numero nota fiscal*</label>
                            <input type="text" name="nota_fiscal" class="form-control" required="required" placeholder="Numero nota fiscal*">
                        </div>
                        </br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="dt_doc" class="form-control" required="required" placeholder="Data Documento*">
                        </div>
                        <div class="form-group">
                        ...
                        <?php
                            if($_POST['btn']){
                                ...
                                if($ext){
                                    ...
                                    echo '<script>alert("É necessário o envio do print do documento. erro"'.$_FILES['documento']['error'].')</script>';
                                }
