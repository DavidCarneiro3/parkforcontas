...
<br />
    <?php
        $idfrmpag = ($_GET['idfrmpag'])?$_GET['idfrmpag']:$_POST['idfrmpag'];
        if($_POST['btn']){
            //print_r($_POST);
            $params = [
                'codigo' => $_POST['codigo'],
            ...
            if($result->result === "sucess"){
                echo '<script>alert("Forma de Pagamento Atualizada.")</script>';
            }else{ 
        ...
        if($_POST['del']){
            $prms = ['action' => '31', 'idfrmpag' => $idfrmpag];
            $del = loadApi($prms);
            //print_r($del);
            if($del->result == 'sucess'){
                echo '<script>
                alert("Registro excluído!");
                window.location.href = "busca_frmpag.php";
                </script>';
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Editar Forma de Pagamento</h2>
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" id="codigo" class="form-control" maxlength="200" value="<?=$res[0]->codigo?>">
                            
                        </div>
                        
                        <div class="form-group">
                        <label style="float: left; margin-left: 2%;">Pagamento</label>
                            <input type="text" name="pagamento" id="pagamento" class="form-control"  maxlength="200" value="<?=$res[0]->pagamento?>">
                        </div>  
                        <div class="form-group">
                            <label style="float: left; margin-left: 2%;">Ativo</label>
                            <select name="ativo">
                                <option value="" >Selecione</option>
                                <option value="Sim" <?=($res[0]->ativo == "Sim")? 'selected' : '' ?>>Sim</option>
                                <option value="Não" <?=($res[0]->ativo == "Não")? 'selected' : '' ?>>Não</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <a class="btn btn-info" href="javascript:location.href = 'busca_frmpag.php'">Voltar</a>
