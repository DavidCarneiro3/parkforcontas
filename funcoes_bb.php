...
$dadosboleto["codigo_barras"] = $dadosb['codigoBarraNumerico'];
//$dadosboleto["linha_digitavel"] = monta_linha_digitavel($dadosb['linhaDigitavel']);
$dadosboleto["linha_digitavel"] = monta_linha_digitavel($dadosb['codigoBarraNumerico']);
...
//Guarda inicial
?>
<img src="http://parkfor.com.br/contas/imagens/p.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img src="http://parkfor.com.br/contas/imagens/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src="http://parkfor.com.br/contas/imagens/p.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src="http://parkfor.com.br/contas/imagens/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
	$texto = "0" . $texto;
...
?>
    src="http://parkfor.com.br/contas/imagens/p.png" width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src="http://parkfor.com.br/contas/imagens/b.png" width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
src="http://parkfor.com.br/contas/imagens/p.png" width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src="http://parkfor.com.br/contas/imagens/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src="http://parkfor.com.br/contas/imagens/p.png" width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
