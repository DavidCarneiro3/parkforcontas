...
<br />
    <?php
        if($_POST['btn']){
            ...
            if($result->result === "sucess"){
                echo '<script>alert("Forma de Pagamento Cadastrada.")</script>';
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Inserir Forma de Pagamento</h2>
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" id="centro" size="3" class="form-control"  maxlength="3" placeholder="Código do pagamento. Ex. PIX, CH, CC...">
                        </div>
                        
                        <div class="form-group">
                        <!-- <label style="float: left; margin-left: 2%;">ISS</label> -->
                            <input type="text" name="pagamento" id="centro" class="form-control"  maxlength="200" placeholder="Forma de Pagamento">
                        </div>  
                        <!-- <div class="form-group"> -->
                        <!-- <label style="float: left; margin-left: 2%;">ISS</label> -->
