    ...
    <?php
        if($_POST['btn']){
            ...
            if($result->result === "sucess"){
                echo '<script>alert("Tipo de Documento Cadastrado.")</script>';
                ...
                <div class="contact-form">
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tipo" id="tipo" size="3" class="form-control"   placeholder="Tipo. Contratos. Alvará, Certificado..">
                        </div>
                        <div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="ATIVO" name="status" id="ativo">
                                <label class="form-check-label" for="ativo"> Ativo</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" value="DESATIVADO" type="radio" name="status" id="desativado">
