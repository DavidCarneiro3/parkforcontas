...
<br />
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Buscar Clientes</h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cliente" id="cliente" class="form-control" placeholder="Informe parte do nome do cliente">
                        </div>
    ...
    <?php 
     if($_POST['btn']){
         ...
         $result = json_decode(listarClientes($params));
         //print_r($result);
            ...
            <table class="table cell-border" id="mytable">
                ...
                <?php foreach($list as $item){ ?>
                    <tr>
                        ...
                        <td><?=$item->site?></td> -->
                        <td>
                            <a href="edt_cli.php?idcli=<?=$item->idcli?>" title="Editar Fornecedor"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                            <a href="#" data-toggle="modal" data-target="#modal<?=$item->idcli?>" title="Detalhes"><i class="fa fa-list" aria-hidden="true"></i></a>
                        </td>
                         <!-- Modal -->
                   <td> <div class="modal fade" id="modal<?=$item->idcli?>" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="ModalLabel">Cliente Detalhado</h5>
                            ...
                            <table class="table">
                            <?php 
                            // $par = ['action' => '14','id_cli' => $item->idcli];
                            // $data = loadApi($par);
                            // $forn = $data->datas;
                            //print_r($forn);
                            ?>
                                
                                <tr><td>Código</td><td><?=$item->idcli?></td></tr>
                                ...
                                <tr><td>Tipo Cliente</td><td><?=$item->tipo_cliente?></td></tr>
                                ...
                                <tr><td>Reter ISS</td><td><?=$item->site?></td></tr>
    ...
    $(function() {
        ...
        $(function() {
            $("#cliente").autocomplete({
                source: 'includes/search_cli.php'
            });
        });
    </script>
</body>
