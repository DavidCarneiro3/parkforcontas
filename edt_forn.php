                ...
                <div class="contact-form">
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                        <div class="form-group">
                            <input type="text" name="cnpj" id="cnpj" class="form-control" value="<?=$res[0]->cpf_cnpj?>" placeholder="CNPJ Apenas números*">
                        </div>
                        </br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <option value="" disabled selected>Selecione</option>
                                <option value="PF" selected="<?=($res[0]->tipo_fornecedor == 'PF')?'true':'false'?>">Pessoa Física</option>
                                <option value="PJ" selected="<?=($res[0]->tipo_fornecedor == 'PJ')?'true':'false'?>">Pessoa Jurídica</option>
                            </select>
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <!-- <label style="float: left; margin-left: 2%;">Endereço</label> -->
                            <input type="text" name="endereco" id="message" value="<?=$res[0]->endereco?>" class="form-control" placeholder="Endereço*" >
                        </div> 
                        <div class="form-group">
