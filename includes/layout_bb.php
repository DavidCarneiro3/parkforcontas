...
#instr_header {
	/* background: url("https://parkfor.com.br/contas/images/parkbg.png") no-repeat top left; */
	padding-left: 160px;
	height: 65px;
}
...
<div id="container">
	...
	<div id="instr_header">
		<h1><?php echo $dadosboleto["cedente"]; ?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?></h1>
...
do Pagador</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><img style="width:85%" src="https://parkfor.com.br/contas/imagens/logobb.png"/></td>
			<td width=50>
		...
		<tbody>
		<tr class="titulos">
			<td class="sacador_avalista" colspan="2">Pagad/Avalista</td>
		</tr>
		<tr class="campos">
		...
		<TBODY>
			<TR>
				<TD width=660 align=right >
					<p style="p-size: 5px; font-size:10px">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensação</p>
				</TD>
			</tr>
		</tbody>
	</table>
