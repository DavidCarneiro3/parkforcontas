                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Data da Exclusão</label>
                                <div class="col-sm-10">
                                    <b>De:</b><input type="date" name="dt_exc_ini" value="<?=$_POST['dt_exc_ini']?>" id="message" class="form-control" placeholder="Data Exclusão">
                                    para:<input type="date" name="dt_exc_fin" id="message" value="<?=$_POST['dt_exc_fin']?>" class="form-control" placeholder="Data Exclusão">
                                </div>
                                </div>   
                                <div class="form-group row">
     ...
     if($_POST['btn']){
        ...
        //if(!$_POST['empresa']){$array = 0;}
         $params = [
             ...
             'dt_exc_ini' => $_POST['dt_exc_ini'],
             'dt_exc_fin' => $_POST['dt_exc_fin'],
