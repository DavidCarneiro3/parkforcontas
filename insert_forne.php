...
<br />
    <?php
        if($_POST['btn']){
            ...
            }else{echo '<script>alert("'.$result->error.' - '.$result->msg.'")</script>';}
        }
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Cadastrar Fornecedor</h2>
                    ...
                    <form id="main-contact-form" class="contact-form row text-left" name="contact-form" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="fornecedor" class="form-control" required="required" placeholder="Fornecedor*">
                        </div>
                        </br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <!-- <label style="float: left; margin-left: 2%;">ISS</label> -->
                            <input type="text" name="site" id="message" class="form-control"  placeholder="Site">
                        </div>                       
                        <div class="form-group">
