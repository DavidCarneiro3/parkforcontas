...
<html lang="en">
    <head>
        ...
        <!-- <link href="https://cdn.datatables.net/1.11.4/css/dataTables.bulma.min.css" rel="stylesheet" type="text/css" /> -->
        <!--[if lt IE 9]>
...
<br />
    ...
    <div class="col-sm-9">
                <div class="contact-form">
                    <h2 class="title text-center">Buscar Tipo de Documento</h2>
            ...
            <table class="table cell-border" id="mytable">
                ...
                <?php foreach($list as $item){ ?>
                    <tr>
                        ...
                        <td><?=$item->status?></td>
                        <td>
                            <a href="edt_tipodoc.php?idtipodoc=<?=$item->idtipodoc?>" title="E ditar Tipo de Documento"><i class="fa fa-gear" aria-hidden="true"></i></s>
